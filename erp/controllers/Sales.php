...
class Sales extends MY_Controller
{
	...
	public function invoice_clinic($id = null)
    {
        ...
        $this->data['customer'] = $this->site->getCompanyByID($inv->customer_id);
		$this->data['saleman'] = $this->site->getUser($inv->saleman_by);
        $this->data['product_notes'] = $this->sales_model->getProductNoteSaleItem($id);
        $this->data['total_items'] = $this->sales_model->getItemQuantitySaleItems($id);
        $this->data['biller'] = $this->site->getCompanyByID($inv->biller_id);
        $this->load->view($this->theme .'sales/invoice_clinic',$this->data);
    }
